...
public class Exercise_1_2_Anagrams {
	...
	public static boolean areAnagrams(String s1, String s2) {
		...
		for (int i = 0; i <= sortedS1.length() - 1; i++) {
	...
	/**
	 * Measures running time of the anagram check Important: Use option -Xint of the
	 * java interpreter in order to get meaningful results.
	 * 
	 */
